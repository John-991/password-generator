...
// Confirm which character sets to use
  ...
  Lowercase ? alert("Your password will have lowercase."): alert("Your password will NOT have lowercase.");
  
  Uppercase = confirm("Do you want uppercase?");
  Uppercase ? alert("Your password will have uppercase."): alert("Your password will NOT have uppercase.");

  Numbers = confirm("Do you want to use numbers?");
  Numbers ? alert("Your password will have numbers."): alert("Your password will NOT have numbers.");

  Specials = confirm("Do you want special characters?");
  Specials ? alert("Your password will have special characters."): alert("Your password will NOT have special characters.");
